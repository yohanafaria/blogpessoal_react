 ...
 * 
 *  **Exemplo**: 'https://blogpessoal-68hk.onrender.com/postagens'
 * 
 * onde:
 * 
 * - https://blogpessoal-68hk.onrender.com é o prefixo (Endereço do Deploy)
 * 
 * - /postagens é a URL do endpoint
 */
const api = axios.create({
    baseURL: "https://blogpessoal-68hk.onrender.com",
})
